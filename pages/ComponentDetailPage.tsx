        ...
        <div className="border-t border-[var(--color-border)]">
          ...
          <div className="p-4 md:p-6">
            {activeTab === "description" ? (
              <div className="text-sm text-[var(--color-text-secondary)] leading-relaxed prose-sm max-w-none" style={{ color: "var(--color-text-secondary)" }}>
                {component.shortDescription || <p>Опис відсутній.</p>}
              </div>
            ) : (
              <div className="overflow-x-auto">
                {component.specifications && component.specifications.length > 0 ? (
                  ...
                  <p className="text-sm text-[var(--color-text-tertiary)]">Характеристики відсутні.</p>
                )}
              </div>
            )}
          </div>
