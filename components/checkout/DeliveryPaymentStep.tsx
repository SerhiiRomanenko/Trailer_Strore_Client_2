      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="space-y-3">
            <label className={radioCard(deliveryData.method === "pickup")}>
              <div className="flex items-center">
                ...
                />
                <span className="ml-3 font-semibold text-[var(--color-text)]">
                  Самовивіз
                </span>
              </div>
              <p className="text-sm text-[var(--color-text-tertiary)] mt-2 ml-7">
                Забрати зі складу: смт. Ворзель, вул. Яблунська, 11
              </p>
            </label>
            <label className={radioCard(deliveryData.method === "nova-poshta")}>
              <div className="flex items-center">
                <input
                  type="radio"
                  name="method"
        ...
        <div>
          ...
          <div className="space-y-3">
            <label className={radioCard(paymentData.method === "cash")}>
              <div className="flex items-center">
                <input
                  type="radio"
                  name="paymentMethod"
            ...
            <label className={radioCard(paymentData.method === "card")}>
              <div className="flex items-center">
                <input
                  type="radio"
                  name="paymentMethod"
